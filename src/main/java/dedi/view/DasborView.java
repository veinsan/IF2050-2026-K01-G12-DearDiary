...
import dedi.Main;
import dedi.controller.DasborController;
...
public class DasborView implements Initializable {
    ...
    private final DasborController controller = new DasborController();
    ...
    private void handleSearch() {
        ...
        List<IdeInovasi> results = controller.cariIde(keyword);
    ...
    private void loadDaftarIde() {
        daftarIdeListView.getItems().setAll(controller.muatDaftarIde());
    }
